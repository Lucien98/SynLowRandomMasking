...
module Q294Ain_2order ( clk, in1, in2, in3, r, klmn, rc, out1, out2, out3 );
  ...
  XNOR2_X1 U4 ( .A(r[12]), .B(in2[0]), .ZN(n416) );
  XNOR2_X1 U5 ( .A(n416), .B(in2[3]), .ZN(N1) );
  XNOR2_X1 U6 ( .A(r[12]), .B(in3[3]), .ZN(n417) );
  XNOR2_X1 U7 ( .A(n417), .B(in3[0]), .ZN(N0) );
endmodule
...
module PRINCE_Sbox_Inverse ( clk, in1, in2, in3, r, klmn_in1, klmn_in2, 
  ...
  Q294Ain_2order Q294_inst1 ( .clk(clk), .in1(in1_reg), .in2(in2_reg), .in3(
        in3_reg), .r({r[11:0], r[42]}), .klmn(klmn_in1), .rc({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .out1(klmn_out1[3:0]), .out2({
        Q294_1_out2, klmn_out1[5:4]}), .out3(Q294_1_out3) );
