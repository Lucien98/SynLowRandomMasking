...
elaborate FourSboxes


current_design FourSboxes
...
write -format verilog -hierarchy -output ../nl/unflattened/FourSboxes.v

ungroup -all -flatten
write -format verilog -hierarchy -output ../nl/flattened/FourSboxes.v
