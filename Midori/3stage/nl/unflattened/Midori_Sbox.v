...
// Date      : Tue Jul  2 23:46:28 2024
/////////////////////////////////////////////////////////////


module MidoriAffines_num1 ( x1, x2, x3, y1, y2, y3 );
  input [3:0] x1;
  input [3:0] x2;
  input [3:0] x3;
  output [3:0] y1;
...
module F_2order ( clk, in1, in2, in3, r, rs, out1, out2, out3 );
  ...
  CF_F_num0 \Inst[0].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({1'b0, in2[1], 
        ...
        rs[0]}), .q(CF_Out[0]) );
  CF_F_num1 \Inst[1].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0}), .q(CF_Out[1]) );
  CF_F_num2 \Inst[2].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 1'b0}), .c({1'b0, in2[2], 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, r[3:2], 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1:0]}), .q(
        CF_Out[2]) );
  CF_F_num3 \Inst[3].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, r[4:3], 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        rs[0]}), .q(CF_Out[3]) );
  CF_F_num4 \Inst[4].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({1'b0, 1'b0, 
  ...
  CF_F_num5 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 1'b0, r[6:5], 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1:0]}), .q(
        CF_Out[5]) );
  CF_F_num6 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
        1'b0, r[7:6], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, rs[0]}), .q(CF_Out[6]) );
  CF_F_num7 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
        r[8:7], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        rs[1], 1'b0}), .q(CF_Out[7]) );
  CF_F_num8 \Inst[8].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({r[8], 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[0]}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1:0]}), .q(
        CF_Out[8]) );
  CF_F_num9 \Inst[9].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        ...
        1'b0}), .q(CF_Out[9]) );
  CF_F_num10 \Inst[10].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
  ...
  CF_F_num11 \Inst[11].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        ...
        .q(CF_Out[11]) );
  CF_F_num12 \Inst[12].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, r[13:12], 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 1'b0, 
        1'b0}), .q(CF_Out[12]) );
  CF_F_num13 \Inst[13].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({
  ...
  CF_F_num14 \Inst[14].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3:2], 1'b0, 1'b0}), 
        .q(CF_Out[14]) );
  CF_F_num15 \Inst[15].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 
  ...
  CF_F_num16 \Inst[16].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
...
module CF_G_num0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num2 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num3 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num4 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num5 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num6 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num7 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num8 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num9 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num10 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num11 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num12 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num13 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num14 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num15 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num16 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num17 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num18 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num19 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num20 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num21 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num22 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num23 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num24 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num25 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num26 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module G_2order ( clk, in1, in2, in3, r, rs, out1, out2, out3 );
  input [3:0] in1;
  input [3:0] in2;
  input [3:0] in3;
  input [17:0] r;
  ...
  CF_G_num0 \Inst[0].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[0]) );
  CF_G_num1 \Inst[1].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, 1'b0, 1'b0, r[13:12]}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[1]) );
  CF_G_num2 \Inst[2].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, 1'b0, r[14:13], 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[2]) );
  CF_G_num3 \Inst[3].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[3]) );
  CF_G_num4 \Inst[4].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, r[15:14], 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[4]) );
  CF_G_num5 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, r[16:15], 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[5]) );
  CF_G_num6 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[6]) );
  CF_G_num7 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        r[17:16], 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[7]) );
  CF_G_num8 \Inst[8].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        r[17], 1'b0, 1'b0, 1'b0, 1'b0, r[12]}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
  ...
  CF_G_num9 \Inst[9].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[9]) );
  CF_G_num10 \Inst[10].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
  ...
  CF_G_num13 \Inst[13].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
  ...
  CF_G_num17 \Inst[17].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
  ...
  CF_G_num18 \Inst[18].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
  ...
  CF_G_num20 \Inst[20].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, r[8:7], 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[20]) );
  CF_G_num21 \Inst[21].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
  ...
  CF_G_num23 \Inst[23].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, r[10:9], 1'b0, 1'b0, 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[23]) );
  CF_G_num24 \Inst[24].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
  ...
  CF_G_num25 \Inst[25].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
...
module Midori_Sbox ( clk, in1, in2, in3, r, rs_in, rs_out, out1, out2, out3 );
  ...
  (* SILVER = "[9:4]_0" *) output [5:0] rs_out;
  ...
  MidoriAffines_num1 InputAffine ( .x1({1'b0, in1[2], 1'b0, in1[0]}), .x2({
  ...
  F_2order F_inst ( .clk(clk), .in1({\InAff_out1_reg[3] , rs_out[3], rs_out[0], 
        rs_out[1]}), .in2({InAff_out2_reg[3:2], rs_out[4], rs_out[5]}), .in3(
