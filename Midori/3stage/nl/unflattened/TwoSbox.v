...
// Date      : Tue Jul  2 23:49:35 2024
/////////////////////////////////////////////////////////////


module MidoriAffines_num1_0 ( x1, x2, x3, y1, y2, y3 );
  input [3:0] x1;
  input [3:0] x2;
  input [3:0] x3;
  output [3:0] y1;
  ...
  XOR2_X1 U1 ( .A(x3[2]), .B(\x3[0] ), .Z(y3[3]) );
  XOR2_X1 U2 ( .A(x2[2]), .B(x2[0]), .Z(y2[3]) );
  XOR2_X1 U3 ( .A(x1[2]), .B(x1[0]), .Z(y1[3]) );
endmodule
...
module CF_F_num0_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(c[1]), .B(b[1]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[1]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r1[0]), .B(a[1]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[0]), .B(r1[1]), .ZN(n8) );
...
module CF_F_num1_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(r1[1]), .B(r1[2]), .Z(n13) );
  INV_X1 U2 ( .A(d[1]), .ZN(n8) );
  AND2_X1 U3 ( .A1(n8), .A2(b[2]), .ZN(n10) );
  NOR2_X1 U4 ( .A1(c[2]), .A2(n8), .ZN(n9) );
  NOR2_X1 U5 ( .A1(n10), .A2(n9), .ZN(n11) );
  XNOR2_X1 U6 ( .A(rs[1]), .B(n11), .ZN(n12) );
  XNOR2_X1 U7 ( .A(n13), .B(n12), .ZN(n14) );
  XNOR2_X1 U8 ( .A(a[1]), .B(n14), .ZN(q) );
endmodule
...
module CF_F_num2_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(c[1]), .B(b[1]), .Z(n6) );
  NAND2_X1 U2 ( .A1(n6), .A2(d[2]), .ZN(n10) );
  XOR2_X1 U3 ( .A(r1[3]), .B(r1[2]), .Z(n8) );
  XNOR2_X1 U4 ( .A(rs[0]), .B(rs[1]), .ZN(n7) );
...
module CF_F_num3_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(c[2]), .B(b[2]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[2]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r1[3]), .B(a[2]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[0]), .B(r1[4]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num4_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(r1[4]), .B(r1[5]), .Z(n13) );
  INV_X1 U2 ( .A(d[2]), .ZN(n8) );
  AND2_X1 U3 ( .A1(n8), .A2(b[0]), .ZN(n10) );
  NOR2_X1 U4 ( .A1(c[0]), .A2(n8), .ZN(n9) );
  NOR2_X1 U5 ( .A1(n10), .A2(n9), .ZN(n11) );
  XNOR2_X1 U6 ( .A(rs[1]), .B(n11), .ZN(n12) );
  XNOR2_X1 U7 ( .A(n13), .B(n12), .ZN(n14) );
  XNOR2_X1 U8 ( .A(a[2]), .B(n14), .ZN(q) );
endmodule
...
module CF_F_num5_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(c[2]), .B(b[2]), .Z(n6) );
  NAND2_X1 U2 ( .A1(n6), .A2(d[0]), .ZN(n10) );
  XOR2_X1 U3 ( .A(r1[6]), .B(r1[5]), .Z(n8) );
  XNOR2_X1 U4 ( .A(rs[0]), .B(rs[1]), .ZN(n7) );
  XNOR2_X1 U5 ( .A(n8), .B(n7), .ZN(n9) );
  XNOR2_X1 U6 ( .A(n10), .B(n9), .ZN(q) );
endmodule
...
module CF_F_num6_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  NAND2_X1 U2 ( .A1(n7), .A2(d[0]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r1[6]), .B(a[0]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[0]), .B(r1[7]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num7_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(c[0]), .B(b[0]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[1]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r1[7]), .B(a[0]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[1]), .B(r1[8]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num8_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  input [5:0] rs;
  output q;
  wire   r1_0, n8, n9, n10, n11, n12, n13;
  assign r1_0 = r1[0];

  AND2_X1 U1 ( .A1(d[0]), .A2(c[1]), .ZN(n9) );
  NOR2_X1 U2 ( .A1(b[1]), .A2(d[0]), .ZN(n8) );
  NOR2_X1 U3 ( .A1(n9), .A2(n8), .ZN(n13) );
  XOR2_X1 U4 ( .A(rs[0]), .B(r1[8]), .Z(n11) );
  XNOR2_X1 U5 ( .A(rs[1]), .B(r1_0), .ZN(n10) );
...
module CF_F_num9_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(b[1]), .B(c[1]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[1]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r2[0]), .B(a[1]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[2]), .B(r2[1]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num10_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  NAND2_X1 U1 ( .A1(d[1]), .A2(c[2]), .ZN(n10) );
  INV_X1 U2 ( .A(d[1]), .ZN(n8) );
  NAND2_X1 U3 ( .A1(b[2]), .A2(n8), .ZN(n9) );
  NAND2_X1 U4 ( .A1(n10), .A2(n9), .ZN(n13) );
  XNOR2_X1 U5 ( .A(a[1]), .B(r2[1]), .ZN(n11) );
  XNOR2_X1 U6 ( .A(n11), .B(rs[3]), .ZN(n12) );
  XNOR2_X1 U7 ( .A(n13), .B(n12), .ZN(n14) );
  XNOR2_X1 U8 ( .A(r2[2]), .B(n14), .ZN(q) );
endmodule
...
module CF_F_num11_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(c[1]), .B(b[1]), .Z(n6) );
  NAND2_X1 U2 ( .A1(n6), .A2(d[2]), .ZN(n10) );
  XOR2_X1 U3 ( .A(r2[3]), .B(r2[2]), .Z(n8) );
  XNOR2_X1 U4 ( .A(rs[2]), .B(rs[3]), .ZN(n7) );
  XNOR2_X1 U5 ( .A(n8), .B(n7), .ZN(n9) );
  XNOR2_X1 U6 ( .A(n10), .B(n9), .ZN(q) );
endmodule
...
module CF_F_num12_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(b[2]), .B(c[2]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[2]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r2[3]), .B(a[2]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[2]), .B(r2[4]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num13_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  NAND2_X1 U1 ( .A1(d[2]), .A2(c[0]), .ZN(n10) );
  INV_X1 U2 ( .A(d[2]), .ZN(n8) );
  NAND2_X1 U3 ( .A1(b[0]), .A2(n8), .ZN(n9) );
  NAND2_X1 U4 ( .A1(n10), .A2(n9), .ZN(n13) );
  XNOR2_X1 U5 ( .A(a[2]), .B(r2[4]), .ZN(n11) );
  XNOR2_X1 U6 ( .A(n11), .B(rs[3]), .ZN(n12) );
  XNOR2_X1 U7 ( .A(n13), .B(n12), .ZN(n14) );
  XNOR2_X1 U8 ( .A(r2[5]), .B(n14), .ZN(q) );
endmodule
...
module CF_F_num15_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(b[0]), .B(c[0]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[0]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r2[6]), .B(a[0]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[2]), .B(r2[7]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num16_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(b[0]), .B(c[0]), .Z(n7) );
  NAND2_X1 U2 ( .A1(n7), .A2(d[1]), .ZN(n11) );
  XOR2_X1 U3 ( .A(r2[7]), .B(a[0]), .Z(n9) );
  XNOR2_X1 U4 ( .A(rs[3]), .B(r2[8]), .ZN(n8) );
  XNOR2_X1 U5 ( .A(n9), .B(n8), .ZN(n10) );
  XNOR2_X1 U6 ( .A(n11), .B(n10), .ZN(q) );
endmodule
...
module CF_F_num17_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  input [5:0] rs;
  output q;
  wire   r2_0, n8, n9, n10, n11, n12, n13, n14;
  assign r2_0 = r2[0];
  ...
  NAND2_X1 U4 ( .A1(n10), .A2(n9), .ZN(n13) );
  XNOR2_X1 U5 ( .A(rs[3]), .B(rs[2]), .ZN(n11) );
  XNOR2_X1 U6 ( .A(n11), .B(r2[8]), .ZN(n12) );
  XNOR2_X1 U7 ( .A(n13), .B(n12), .ZN(n14) );
  XNOR2_X1 U8 ( .A(r2_0), .B(n14), .ZN(q) );
endmodule
...
module CF_F_num19_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XNOR2_X1 U1 ( .A(r3[2]), .B(c[2]), .ZN(n8) );
  XOR2_X1 U2 ( .A(rs[5]), .B(r3[1]), .Z(n6) );
...
module CF_F_num20_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(r3[3]), .B(rs[5]), .Z(n7) );
  XNOR2_X1 U2 ( .A(r3[2]), .B(a[1]), .ZN(n6) );
  XNOR2_X1 U3 ( .A(n7), .B(n6), .ZN(n8) );
  XOR2_X1 U4 ( .A(rs[4]), .B(n8), .Z(n10) );
...
module CF_F_num21_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(rs[4]), .B(r3[4]), .Z(n5) );
  NAND2_X1 U2 ( .A1(b[2]), .A2(d[2]), .ZN(n4) );
  XNOR2_X1 U3 ( .A(n5), .B(n4), .ZN(n6) );
  XOR2_X1 U4 ( .A(r3[3]), .B(n6), .Z(q) );
endmodule
...
module CF_F_num22_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XNOR2_X1 U1 ( .A(r3[5]), .B(c[0]), .ZN(n8) );
  XOR2_X1 U2 ( .A(rs[5]), .B(r3[4]), .Z(n6) );
...
module CF_F_num23_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(r3[6]), .B(rs[5]), .Z(n7) );
  XNOR2_X1 U2 ( .A(r3[5]), .B(a[2]), .ZN(n6) );
  XNOR2_X1 U3 ( .A(n7), .B(n6), .ZN(n8) );
  XOR2_X1 U4 ( .A(rs[4]), .B(n8), .Z(n10) );
...
module CF_F_num24_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XOR2_X1 U1 ( .A(rs[4]), .B(r3[7]), .Z(n5) );
  NAND2_X1 U2 ( .A1(b[0]), .A2(d[0]), .ZN(n4) );
  XNOR2_X1 U3 ( .A(n5), .B(n4), .ZN(n6) );
  XOR2_X1 U4 ( .A(r3[6]), .B(n6), .Z(q) );
endmodule
...
module CF_F_num25_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  XNOR2_X1 U1 ( .A(r3[8]), .B(a[0]), .ZN(n8) );
  XOR2_X1 U2 ( .A(rs[5]), .B(r3[7]), .Z(n6) );
...
module CF_F_num26_0 ( a, b, c, d, r1, r2, r3, rs, q );
  ...
  input [5:0] rs;
  output q;
  wire   r3_0, n6, n7, n8, n9, n10;
  assign r3_0 = r3[0];

  XOR2_X1 U1 ( .A(r3_0), .B(rs[5]), .Z(n7) );
  XNOR2_X1 U2 ( .A(r3[8]), .B(c[1]), .ZN(n6) );
  XNOR2_X1 U3 ( .A(n7), .B(n6), .ZN(n8) );
  XOR2_X1 U4 ( .A(rs[4]), .B(n8), .Z(n10) );
  NAND2_X1 U5 ( .A1(b[1]), .A2(d[0]), .ZN(n9) );
  XNOR2_X1 U6 ( .A(n10), .B(n9), .ZN(q) );
endmodule
...
module F_2order_0 ( clk, in1, in2, in3, r, rs, out1, out2, out3 );
  ...
  CF_F_num0_0 \Inst[0].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({1'b0, in2[1], 
        ...
        rs[0]}), .q(CF_Out[0]) );
  CF_F_num1_0 \Inst[1].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[2:1], 1'b0}), .r2({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1], 
        1'b0}), .q(CF_Out[1]) );
  ...
  CF_F_num5_0 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1:0]}), 
        .q(CF_Out[5]) );
  CF_F_num6_0 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
        1'b0, r[7:6], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, rs[0]}), .q(CF_Out[6]) );
  CF_F_num7_0 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
        r[8:7], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        rs[1], 1'b0}), .q(CF_Out[7]) );
  CF_F_num8_0 \Inst[8].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({r[8], 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[0]}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        rs[1:0]}), .q(CF_Out[8]) );
  CF_F_num9_0 \Inst[9].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[10:9]}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 1'b0, 
        1'b0}), .q(CF_Out[9]) );
  CF_F_num10_0 \Inst[10].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, r[11:10], 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3], 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[10]) );
  CF_F_num11_0 \Inst[11].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, r[12:11], 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3:2], 1'b0, 1'b0}), 
        .q(CF_Out[11]) );
  CF_F_num12_0 \Inst[12].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, r[13:12], 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 1'b0, 
        1'b0}), .q(CF_Out[12]) );
  CF_F_num13_0 \Inst[13].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 
        1'b0, 1'b0, r[14:13], 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3], 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[13]) );
  CF_F_num14_0 \Inst[14].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3:2], 1'b0, 1'b0}), 
        .q(CF_Out[14]) );
  CF_F_num15_0 \Inst[15].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 
        r[16:15], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 
        1'b0, 1'b0}), .q(CF_Out[15]) );
  CF_F_num16_0 \Inst[16].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
  ...
  CF_F_num23_0 \Inst[23].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({rs[5:4], 1'b0, 1'b0, 1'b0, 1'b0}), 
        .q(CF_Out[23]) );
  CF_F_num24_0 \Inst[24].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, r[25:24], 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, rs[4], 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[24]) );
  CF_F_num25_0 \Inst[25].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({r[26:25], 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({rs[5], 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[25]) );
  CF_F_num26_0 \Inst[26].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({r[26], 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[18]}), .rs({rs[5:4], 1'b0, 1'b0, 1'b0, 
        1'b0}), .q(CF_Out[26]) );
  ...
  DFF_X1 \areg_reg[2]  ( .D(in3[0]), .CK(clk), .Q(out2[2]) );
  DFF_X1 \areg_reg[1]  ( .D(in2[0]), .CK(clk), .Q(out1[2]) );
  DFF_X1 \areg_reg[0]  ( .D(in1[0]), .CK(clk), .Q(out3[2]) );
endmodule


module CF_G_num0_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num1_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num2_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r3[1]), .B(r3[2]), .Z(n6) );
  NAND2_X1 U2 ( .A1(b[1]), .A2(d[2]), .ZN(n5) );
  XNOR2_X1 U3 ( .A(n6), .B(n5), .ZN(q) );
endmodule


module CF_G_num3_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num4_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num5_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r3[3]), .B(r3[4]), .Z(n6) );
  NAND2_X1 U2 ( .A1(b[2]), .A2(d[0]), .ZN(n5) );
  XNOR2_X1 U3 ( .A(n6), .B(n5), .ZN(q) );
endmodule


module CF_G_num6_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  AND2_X1 U1 ( .A1(b[0]), .A2(d[0]), .ZN(q) );
endmodule


module CF_G_num7_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r3[4]), .B(n1), .Z(n5) );
  NAND2_X1 U2 ( .A1(b[0]), .A2(d[1]), .ZN(n4) );
  XNOR2_X1 U3 ( .A(n5), .B(n4), .ZN(q) );
endmodule


module CF_G_num8_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r3[5]), .B(n1), .Z(n7) );
  NAND2_X1 U2 ( .A1(b[1]), .A2(d[0]), .ZN(n6) );
  XNOR2_X1 U3 ( .A(n7), .B(n6), .ZN(n8) );
  XOR2_X1 U4 ( .A(c[1]), .B(n8), .Z(q) );
endmodule


module CF_G_num9_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num10_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num11_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r1[1]), .B(n1), .Z(n7) );
  NAND2_X1 U2 ( .A1(b[1]), .A2(d[2]), .ZN(n6) );
  XNOR2_X1 U3 ( .A(n7), .B(n6), .ZN(n8) );
  XOR2_X1 U4 ( .A(c[2]), .B(n8), .Z(q) );
endmodule


module CF_G_num12_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num13_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num14_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r1[3]), .B(n1), .Z(n7) );
  NAND2_X1 U2 ( .A1(b[2]), .A2(d[0]), .ZN(n6) );
  XNOR2_X1 U3 ( .A(n7), .B(n6), .ZN(n8) );
  XOR2_X1 U4 ( .A(c[0]), .B(n8), .Z(q) );
endmodule


module CF_G_num15_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num16_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num17_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r1[5]), .B(r1_0), .Z(n8) );
  INV_X1 U2 ( .A(b[1]), .ZN(n6) );
  NAND2_X1 U3 ( .A1(d[0]), .A2(n6), .ZN(n7) );
  XNOR2_X1 U4 ( .A(n8), .B(n7), .ZN(q) );
endmodule


module CF_G_num18_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  NAND2_X1 U2 ( .A1(d[1]), .A2(n3), .ZN(q) );
endmodule


module CF_G_num19_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XNOR2_X1 U5 ( .A(n11), .B(r2[0]), .ZN(n12) );
  XNOR2_X1 U6 ( .A(r2[1]), .B(n12), .ZN(q) );
endmodule


module CF_G_num20_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r2[1]), .B(n1), .Z(n8) );
  XOR2_X1 U2 ( .A(c[1]), .B(b[1]), .Z(n6) );
  NAND2_X1 U3 ( .A1(n6), .A2(d[2]), .ZN(n7) );
  XNOR2_X1 U4 ( .A(n8), .B(n7), .ZN(q) );
endmodule


module CF_G_num21_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(c[2]), .B(b[2]), .Z(n3) );
  AND2_X1 U2 ( .A1(d[2]), .A2(n3), .ZN(q) );
endmodule


module CF_G_num22_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  NAND2_X1 U4 ( .A1(n10), .A2(n9), .ZN(n11) );
  XNOR2_X1 U5 ( .A(n11), .B(r2[2]), .ZN(n12) );
  XNOR2_X1 U6 ( .A(r2[3]), .B(n12), .ZN(q) );
endmodule


module CF_G_num23_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(r2[3]), .B(n1), .Z(n8) );
  XOR2_X1 U2 ( .A(c[2]), .B(b[2]), .Z(n6) );
  NAND2_X1 U3 ( .A1(n6), .A2(d[0]), .ZN(n7) );
  XNOR2_X1 U4 ( .A(n8), .B(n7), .ZN(q) );
endmodule


module CF_G_num24_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  XOR2_X1 U1 ( .A(c[0]), .B(b[0]), .Z(n3) );
  AND2_X1 U2 ( .A1(d[0]), .A2(n3), .ZN(q) );
endmodule


module CF_G_num25_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num26_0 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
  ...
  NAND2_X1 U3 ( .A1(d[0]), .A2(c[1]), .ZN(n9) );
  NAND2_X1 U4 ( .A1(n10), .A2(n9), .ZN(n11) );
  XNOR2_X1 U5 ( .A(n11), .B(r2[5]), .ZN(n12) );
  XNOR2_X1 U6 ( .A(r2_0), .B(n12), .ZN(q) );
endmodule
...
module G_2order_0 ( clk, in1, in2, in3, r, rs, out1, out2, out3 );
  input [3:0] in1;
  input [3:0] in2;
  input [3:0] in3;
  input [17:0] r;
  ...
  CF_G_num0_0 \Inst[0].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[0]) );
  CF_G_num1_0 \Inst[1].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, r[13:12]}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[1]) );
  CF_G_num2_0 \Inst[2].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, r[14:13], 1'b0}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[2]) );
  CF_G_num3_0 \Inst[3].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[3]) );
  CF_G_num4_0 \Inst[4].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .r3({1'b0, 1'b0, r[15:14], 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[4]) );
  CF_G_num5_0 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, r[16:15], 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[5]) );
  CF_G_num6_0 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[6]) );
  CF_G_num7_0 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({r[17:16], 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[7]) );
  CF_G_num8_0 \Inst[8].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({r[17], 1'b0, 1'b0, 1'b0, 1'b0, r[12]}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[8]) );
  CF_G_num9_0 \Inst[9].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[9]) );
  CF_G_num10_0 \Inst[10].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, r[1:0]}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[10]) );
  ...
  CF_G_num12_0 \Inst[12].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[12]) );
  CF_G_num13_0 \Inst[13].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
  ...
  CF_G_num15_0 \Inst[15].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[15]) );
  CF_G_num16_0 \Inst[16].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        ...
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[16]) );
  CF_G_num17_0 \Inst[17].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({r[5], 
        1'b0, 1'b0, 1'b0, 1'b0, r[0]}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[17]) );
  CF_G_num18_0 \Inst[18].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[18]) );
  ...
  CF_G_num20_0 \Inst[20].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, r[8:7], 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[20]) );
  CF_G_num21_0 \Inst[21].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[21]) );
  CF_G_num22_0 \Inst[22].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, r[9:8], 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[22]) );
  CF_G_num23_0 \Inst[23].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
  ...
  DFF_X1 \CF_Reg_reg[1]  ( .D(CF_Out[1]), .CK(clk), .Q(CF_Reg[1]) );
  DFF_X1 \CF_Reg_reg[0]  ( .D(CF_Out[0]), .CK(clk), .Q(CF_Reg[0]) );
  DFF_X1 \areg_reg[2]  ( .D(in3[0]), .CK(clk), .Q(out2[1]) );
  DFF_X1 \areg_reg[1]  ( .D(in2[0]), .CK(clk), .Q(out1[1]) );
  DFF_X1 \areg_reg[0]  ( .D(in1[0]), .CK(clk), .Q(out3[1]) );
endmodule


module Midori_Sbox_0 ( clk, in1, in2, in3, r, rs_in, rs_out, out1, out2, out3
 );
  input [3:0] in1;
  input [3:0] in2;
  input [3:0] in3;
  ...
  output [3:0] out3;
  input clk;
  wire   \InAff_out1[3] , \InAff_out1_reg[3] ;
  wire   [3:0] InAff_out2;
  wire   [3:0] InAff_out3;
  ...
  MidoriAffines_num1_0 InputAffine ( .x1({1'b0, in1[2], 1'b0, in1[0]}), .x2({
        in2[3:2], 1'b0, in2[0]}), .x3(in3), .y1({\InAff_out1[3] , 
        SYNOPSYS_UNCONNECTED__0, SYNOPSYS_UNCONNECTED__1, 
        SYNOPSYS_UNCONNECTED__2}), .y2({InAff_out2[3:2], 
        SYNOPSYS_UNCONNECTED__3, SYNOPSYS_UNCONNECTED__4}), .y3(InAff_out3) );
  F_2order_0 F_inst ( .clk(clk), .in1({\InAff_out1_reg[3] , rs_out[3], 
        rs_out[0], rs_out[1]}), .in2({InAff_out2_reg[3:2], rs_out[4], 
        rs_out[5]}), .in3(InAff_out3_reg), .r(r[26:0]), .rs(rs_in), .out1(
        Q12_1_out1), .out2(Q12_1_out2), .out3(Q12_1_out3) );
  G_2order_0 G_inst ( .clk(clk), .in1(Q12_1_out1), .in2(Q12_1_out2), .in3(
        Q12_1_out3), .r(r[44:27]), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), 
  ...
  DFF_X1 \InAff_out3_reg_reg[0]  ( .D(InAff_out3[0]), .CK(clk), .Q(
        InAff_out3_reg[0]) );
  DFF_X1 \in1_reg_reg[3]  ( .D(in1[3]), .CK(clk), .Q(rs_out[3]) );
  DFF_X1 \in1_reg_reg[2]  ( .D(in1[2]), .CK(clk), .Q(rs_out[2]) );
  DFF_X1 \in1_reg_reg[1]  ( .D(in1[1]), .CK(clk), .Q(rs_out[1]) );
  DFF_X1 \in1_reg_reg[0]  ( .D(in1[0]), .CK(clk), .Q(rs_out[0]) );
  DFF_X1 \in2_reg_reg[1]  ( .D(in2[1]), .CK(clk), .Q(rs_out[5]) );
  DFF_X1 \in2_reg_reg[0]  ( .D(in2[0]), .CK(clk), .Q(rs_out[4]) );
endmodule
...
module F_2order_1 ( clk, in1, in2, in3, r, rs, out1, out2, out3 );
  ...
  CF_F_num0_1 \Inst[0].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[1:0]}), .r2({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        rs[0]}), .q(CF_Out[0]) );
  CF_F_num1_1 \Inst[1].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[2:1], 1'b0}), .r2({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1], 
  ...
  CF_F_num2_1 \Inst[2].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1:0]}), 
        .q(CF_Out[2]) );
  CF_F_num3_1 \Inst[3].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, r[4:3], 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        rs[0]}), .q(CF_Out[3]) );
  CF_F_num4_1 \Inst[4].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({
        1'b0, 1'b0, 1'b0, r[5:4], 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
  ...
  CF_F_num5_1 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, rs[1:0]}), 
        .q(CF_Out[5]) );
  CF_F_num6_1 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
        1'b0, r[7:6], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, rs[0]}), .q(CF_Out[6]) );
  CF_F_num7_1 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
        r[8:7], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
  ...
  CF_F_num8_1 \Inst[8].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        rs[1:0]}), .q(CF_Out[8]) );
  CF_F_num9_1 \Inst[9].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, r[10:9]}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 1'b0, 
        1'b0}), .q(CF_Out[9]) );
  CF_F_num10_1 \Inst[10].CF_Inst  ( .a({1'b0, in2[0], 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, r[11:10], 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3], 1'b0, 1'b0, 
  ...
  CF_F_num11_1 \Inst[11].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3:2], 1'b0, 1'b0}), 
        .q(CF_Out[11]) );
  CF_F_num12_1 \Inst[12].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 
        1'b0, 1'b0, r[13:12], 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 1'b0, 
        1'b0}), .q(CF_Out[12]) );
  CF_F_num13_1 \Inst[13].CF_Inst  ( .a({in3[0], 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({in3[3], 1'b0, 1'b0}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 
        1'b0, 1'b0, r[14:13], 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3], 1'b0, 
  ...
  CF_F_num14_1 \Inst[14].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3:2], 1'b0, 1'b0}), 
        .q(CF_Out[14]) );
  CF_F_num15_1 \Inst[15].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, 1'b0, in1[3]}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 
        r[16:15], 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, rs[2], 
        1'b0, 1'b0}), .q(CF_Out[15]) );
  CF_F_num16_1 \Inst[16].CF_Inst  ( .a({1'b0, 1'b0, in1[0]}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, in1[2]}), .d({1'b0, in2[3], 1'b0}), .r1({
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({r[17:16], 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r3({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, rs[3], 1'b0, 
...
module CF_G_num22_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num19_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num26_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num25_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num23_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num20_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num16_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num14_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num11_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num8_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num4_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num1_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num17_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num13_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num10_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num7_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num5_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num2_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num24_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num21_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num18_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num15_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num12_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num9_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num6_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num3_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module CF_G_num0_1 ( a, b, c, d, r1, r2, r3, rs, q );
  input [2:0] a;
  input [2:0] b;
  input [2:0] c;
  input [2:0] d;
...
module G_2order_1 ( clk, in1, in2, in3, r, rs, out1, out2, out3 );
  input [3:0] in1;
  input [3:0] in2;
  input [3:0] in3;
  input [17:0] r;
  ...
  CF_G_num0_1 \Inst[0].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[0]) );
  CF_G_num1_1 \Inst[1].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, r[13:12]}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[1]) );
  CF_G_num2_1 \Inst[2].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, r[14:13], 1'b0}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[2]) );
  CF_G_num3_1 \Inst[3].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[3]) );
  CF_G_num4_1 \Inst[4].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        ...
        1'b0, 1'b0}), .r3({1'b0, 1'b0, r[15:14], 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[4]) );
  CF_G_num5_1 \Inst[5].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, r[16:15], 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[5]) );
  CF_G_num6_1 \Inst[6].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[6]) );
  CF_G_num7_1 \Inst[7].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({r[17:16], 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0}), .q(CF_Out[7]) );
  ...
  CF_G_num9_1 \Inst[9].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        ...
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[9]) );
  CF_G_num10_1 \Inst[10].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, r[1:0]}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[10]) );
  ...
  CF_G_num12_1 \Inst[12].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[12]) );
  CF_G_num13_1 \Inst[13].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        in1[1]}), .c({1'b0, 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, r[3:2], 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[13]) );
  ...
  CF_G_num16_1 \Inst[16].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        ...
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[16]) );
  CF_G_num17_1 \Inst[17].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({r[5], 
        1'b0, 1'b0, 1'b0, 1'b0, r[0]}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[17]) );
  CF_G_num18_1 \Inst[18].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({1'b0, in2[3], 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[18]) );
  CF_G_num19_1 \Inst[19].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        ...
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[19]) );
  CF_G_num20_1 \Inst[20].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, in2[1], 
        1'b0}), .c({1'b0, in2[2], 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, r[8:7], 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[20]) );
  CF_G_num21_1 \Inst[21].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({in3[3], 1'b0, 1'b0}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[21]) );
  CF_G_num22_1 \Inst[22].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({1'b0, 1'b0, 
        ...
        1'b0}), .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0}), .q(CF_Out[22]) );
  CF_G_num23_1 \Inst[23].CF_Inst  ( .a({1'b0, 1'b0, 1'b0}), .b({in3[1], 1'b0, 
        1'b0}), .c({in3[2], 1'b0, 1'b0}), .d({1'b0, 1'b0, in1[3]}), .r1({1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .r2({1'b0, r[10:9], 1'b0, 1'b0, 1'b0}), 
        .r3({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0}), .rs({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0}), .q(CF_Out[23]) );
...
module MidoriAffines_num1_1 ( x1, x2, x3, y1, y2, y3 );
  input [3:0] x1;
  input [3:0] x2;
  input [3:0] x3;
  output [3:0] y1;
...
module Midori_Sbox_1 ( clk, in1, in2, in3, r, rs_in, rs_out, out1, out2, out3
 );
  input [3:0] in1;
  input [3:0] in2;
  input [3:0] in3;
  ...
  MidoriAffines_num1_1 InputAffine ( .x1({1'b0, in1[2], 1'b0, in1[0]}), .x2({
        in2[3:2], 1'b0, in2[0]}), .x3(in3), .y1({\InAff_out1[3] , 
        SYNOPSYS_UNCONNECTED__0, SYNOPSYS_UNCONNECTED__1, 
        SYNOPSYS_UNCONNECTED__2}), .y2({InAff_out2[3:2], 
        SYNOPSYS_UNCONNECTED__3, SYNOPSYS_UNCONNECTED__4}), .y3(InAff_out3) );
  F_2order_1 F_inst ( .clk(clk), .in1({\InAff_out1_reg[3] , rs_out[3], 
        rs_out[0], rs_out[1]}), .in2({InAff_out2_reg[3:2], rs_out[4], 
        rs_out[5]}), .in3(InAff_out3_reg), .r(r[26:0]), .rs(rs_in), .out1(
        Q12_1_out1), .out2(Q12_1_out2), .out3(Q12_1_out3) );
...
(* SILVER="clock" *)  input clk;
  ...
  Midori_Sbox_0 S1 ( .clk(clk), .in1(in1[3:0]), .in2(in2[3:0]), .in3(in3[3:0]), 
        .r(r[44:0]), .rs_in(rs2), .rs_out(rs1), .out1(out1[3:0]), .out2(
        out2[3:0]), .out3(out3[3:0]) );
  Midori_Sbox_1 S2 ( .clk(clk), .in1(in1[7:4]), .in2(in2[7:4]), .in3(in3[7:4]), 
        .r(r[89:45]), .rs_in(rs1), .rs_out(rs2), .out1(out1[7:4]), .out2(
        out2[7:4]), .out3(out3[7:4]) );
endmodule
