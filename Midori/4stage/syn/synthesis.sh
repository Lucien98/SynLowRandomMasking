...
analyze -format verilog  {../RTL/MidoriAffines.v}
analyze -format verilog  {../RTL/Midori_Sbox.v}
analyze -format verilog  {../RTL/Q12_2order.v}
analyze -format verilog  {../RTL/XOR_3.v}

elaborate Midori_Sbox


current_design Midori_Sbox
...
write -format verilog -hierarchy -output ../nl/unflattened/Midori_Sbox.v

ungroup -all -flatten
write -format verilog -hierarchy -output ../nl/flattened/Midori_Sbox.v
