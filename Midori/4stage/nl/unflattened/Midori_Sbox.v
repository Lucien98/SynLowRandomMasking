...
module MidoriAffines_num1 ( x1, x2, x3, y1, y2, y3 );
  ...
  output [3:0] y2;
  output [3:0] y3;
  wire   \x1[3] , \x1[0] , \x1[1] , \x2[3] , \x2[0] , \x2[1] , \x3[3] ,
         \x3[0] , \x3[1] ;
  assign y1[2] = \x1[3] ;
  assign \x1[3]  = x1[3];
  assign y1[1] = \x1[0] ;
...
module MidoriAffines_num3 ( x1, x2, x3, y1, y2, y3 );
  input [3:0] x1;
  input [3:0] x2;
  input [3:0] x3;
  output [3:0] y1;
  output [3:0] y2;
  output [3:0] y3;
  wire   \x1[0] , \x1[1] , \x2[0] , \x2[1] , \x3[0] , \x3[1] ;
  assign y1[2] = \x1[0] ;
  assign \x1[0]  = x1[0];
  assign y1[1] = \x1[1] ;
  assign \x1[1]  = x1[1];
  ...
  XNOR2_X1 U1 ( .A(x3[2]), .B(\x3[0] ), .ZN(y3[3]) );
  XOR2_X1 U2 ( .A(x3[3]), .B(\x3[1] ), .Z(y3[0]) );
  XNOR2_X1 U3 ( .A(x2[2]), .B(\x2[0] ), .ZN(y2[3]) );
  XOR2_X1 U4 ( .A(x2[3]), .B(\x2[1] ), .Z(y2[0]) );
  XNOR2_X1 U5 ( .A(x1[2]), .B(\x1[0] ), .ZN(y1[3]) );
  XOR2_X1 U6 ( .A(x1[3]), .B(\x1[1] ), .Z(y1[0]) );
endmodule
...
module MidoriAffines_num2 ( x1, x2, x3, y1, y2, y3 );
  input [3:0] x1;
  input [3:0] x2;
  input [3:0] x3;
  output [3:0] y1;
  output [3:0] y2;
  output [3:0] y3;
  wire   x1_1, \x1[0] , \x1[2] , \x2[1] , \x2[0] , \x2[2] , \x3[1] , \x3[0] ,
         \x3[2] ;
  assign x1_1 = x1[1];
  assign y1[1] = \x1[0] ;
  assign \x1[0]  = x1[0];
  ...
  XOR2_X1 U1 ( .A(x3[3]), .B(\x3[2] ), .Z(y3[2]) );
  XOR2_X1 U2 ( .A(x2[3]), .B(\x2[2] ), .Z(y2[2]) );
  XOR2_X1 U3 ( .A(x1[3]), .B(\x1[2] ), .Z(y1[2]) );
  INV_X1 U4 ( .A(x1_1), .ZN(y1[3]) );
endmodule


module Midori_Sbox ( clk, in1, in2, in3, r, out1, out2, out3 );
  ...
  MidoriAffines_num1 InputAffine ( .x1(in1), .x2(in2), .x3(in3), .y1(
  ...
  MidoriAffines_num3 MiddleAffine ( .x1(Q294_1_out1), .x2(Q294_1_out2), .x3(
  ...
  MidoriAffines_num2 OutputAffine ( .x1(Q294_2_out1), .x2(Q294_2_out2), .x3(
